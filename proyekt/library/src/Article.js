...
function Article(props) {
  ...
  useEffect(() => {
    fetch('http://127.0.0.1:8000/fiskal/article/')
  ...
  return (
    ...
    <div className='container'>
      <div className="mt-4">
      <h1 className="text-blue-600 font-medium text-2xl items-center text-center m-10">Articles</h1>
    <Swiper
          ...
          <SwiperSlide key={item.id}>
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="flex-1 p-4 bg-white dark:bg-gray-800">
                ...
                <div className="mt-4">{Rate(item.ratings)}</div>
                <div className="mt-6">
                  <a href={`/article/${item.id}`} className="text-base font-medium text-blue-500 hover:text-blue-400">
                    Read more
                  </a>
                </div>
              </div>
