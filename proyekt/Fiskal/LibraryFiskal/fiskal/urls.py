...
from .views import BestRatedAPIView,BestAudioBookView,EventView,ArticleView,WorkView,BookidView,audioid,eventid,articleid,workid,Tagname,ATagname,WTagname,ArTagname,CreateRateView, Search,CreateWishlistView,ReturnWishlist
...
urlpatterns = [
    ...
    path('wish/create/', CreateWishlistView.as_view(), name='create_wish'),
    path('wish/', ReturnWishlist.as_view(), name='wish'),
