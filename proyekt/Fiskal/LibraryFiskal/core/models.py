...
class Book(models.Model):
    ...
    ratings = GenericRelation(Rate,related_query_name='ratedb')
    wishedby = GenericRelation(Wishlist,related_query_name='wishedb',null=True,blank=True)
...
class AudioBook(models.Model):
    ...
    ratings = GenericRelation(Rate,related_query_name='ratedau')
    wishedby = GenericRelation(Wishlist,related_query_name='wishedau',null=True,blank=True)
...
class Article(models.Model):
    ...
    ratings = GenericRelation(Rate,related_query_name='rateda')
    wishedby = GenericRelation(Wishlist,related_query_name='wisheda',null=True,blank=True)
...
class Work(models.Model):
    ...
    ratings = GenericRelation(Rate,related_query_name='ratedw')
    wishedby = GenericRelation(Wishlist,related_query_name='wishedw',null=True,blank=True)
